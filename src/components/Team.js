      ...
      <div className='team'>
        <div className="story-content">
          ...
          <p className="font-paragraphs story-text">
            ...
            fringilla urna porttitor rhoncus. Ullamcorper velit sed ullamcorper
            morbi tincidunt. Ac placerat vestibulum lectus mauris. Netus et
            malesuada fames ac. In dictum non consectetur a. Et sollicitudin ac
            orci phasellus egestas tellus rutrum. Eget lorem dolor sed viverra
            ipsum nunc. Odio ut sem nulla pharetra. Varius duis at consectetur
            lorem donec massa sapien. Et molestie ac feugiat sed. Eget nullam
            non nisi est sit amet facilisis. Vel fringilla est ullamcorper eget
            nulla facilisi etiam dignissim diam. Ut faucibus pulvinar elementum
            integer enim. Est lorem ipsum dolor sit amet consectetur adipiscing
            elit.
          </p>
        </div>
        <div className="founder-message">
          ...
          <p className="font-paragraphs founder-message-text">
            ...
            Aliquet bibendum enim facilisis gravida neque convallis a cras. Vel
            fringilla est ullamcorper eget nulla facilisi etiam dignissim. Massa
            tincidunt dui ut ornare lectus sit amet Massa tincidunt dui ut
