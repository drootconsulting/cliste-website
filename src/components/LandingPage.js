            ...
            <div className="working">
                <div className='font-headings working-heading'>What it does</div>
                    <div className='row card-detail'>
                        <div className="card col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-3 font-pragraphs working-card" >
                        ...
                        <div className='col-xs-12 col-sm-6 col-md-8 col-lg-8 '>
                            <div className="card tech-adv-section-text" >
                                ...
                                <div className="card-body tech-adv-text">
                                    ...
                                    <p className="card-text font-pragraphs" style={{ color: "#363638" }}>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
                            </div>
                        </div>
