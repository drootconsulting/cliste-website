            ...
            <div className='content desktop-view'>
                <div className='row intro'>
                    <div className='font-headings col-xs-12 col-sm-12 col-md-6 col-lg-6'>
                        ...
                        <p className='font-paragraphs text'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <Button className='intro-btn font-paragraphs'><Telephone className='telephone-icon font-paragraphs' /><span>Request a call</span></Button>
            ...
            <div className='content mobile-view'>
                <div className='row intro'>
                    ...
                    <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6 hero-image'>
                        ...
                        <Button className='intro-btn font-paragraphs mobile-view-btn'><Telephone className='telephone-icon font-paragraphs' /><span>Request a call</span></Button>
                        <Button className='intro-btn font-paragraphs mobile-view-btn'><Cart className='telephone-icon font-paragraphs' /><span>Buy now</span></Button>
                        <p className='font-paragraphs text'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    </div>
